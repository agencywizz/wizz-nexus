...
The `config/workspace.yaml` file is the central configuration for your WizzOS instance. It's generated by `make setup` and read by the dashboard, scheduler, and setup scripts.
